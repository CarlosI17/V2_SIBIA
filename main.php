...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Inicio | Sistema de Busqueda de AREL</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="author" content="Carlos Inca" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=start" class="logo">
          <img style="margin-top:-5px;margin-right:5px" src="assets/img/AREL.png" alt="Logo" width="200px" height="70px"> 
           <!-- <span style="font-size:20px">SIBIA</span> -->
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a target="_blank">Area de Registro, Escalafon y Legajos</a></strong>
      </footer>
    </div><!-- ./wrapper -->
