...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | Sistema de Busqueda de AREL</title>
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/AREL.png" alt="Logo"> 
      </div><!-- /.login-logo -->
      <?php  
      ...
      elseif ($_GET['alert'] == 2) {
        echo "<div class='alert alert-success alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4>  <i class='icon fa fa-check-circle'></i> Has salido con éxito.</h4>
				<meta http-equiv='refresh' content='1; url= ../medisys/index.php' />
              </div>";
      }
      ?>
