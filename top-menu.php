...
$query = mysqli_query($mysqli, "SELECT id_user, name_user, foto, permisos_acceso,cargo FROM usuarios WHERE id_user='$_SESSION[id_user]'")
    ...
    <li class="user-header">
      ...
      <p>
        <?php echo $data['name_user']; ?>
		   <small> <?php echo $data['cargo']; ?></small>     
      </p>
    </li>
